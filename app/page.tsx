      ...
      {pantalla === "bienvenida" ? (
        ...
        <div className="max-w-4xl mx-auto p-6">
          <Card className="shadow-lg">
            <CardContent className="p-8">
              <div className="space-y-6">
                {/* CHANGE> Dynamic icon color based on risk level */}
                <div className="flex items-center justify-center space-x-3 mb-6">
                  <div
                  ...
                  >
                    <h3
                      className={`text-lg font-semibold mb-4 ${
                        resultado < 0.01 ? "text-green-900" : resultado >= 0.95 ? "text-red-900" : "text-amber-900"
                      }`}
                    >
                    ...
                    <div
                      className={`text-5xl font-bold mb-4 ${
                        resultado < 0.01 ? "text-green-700" : resultado >= 0.95 ? "text-red-700" : "text-amber-700"
                      }`}
                    >
                    ...
                    <p
                      className={`text-sm ${
                        resultado < 0.01 ? "text-green-800" : resultado >= 0.95 ? "text-red-800" : "text-amber-800"
                      }`}
                    >
                      {resultado >= 0.95
                        ? "Alta probabilidad de embarazo ectópico"
                      ...
                      resultado !== null
                        ? resultado < 0.01
                          ...
                          : resultado >= 0.95
                            ...
                            : "border-amber-300 text-amber-600 hover:bg-amber-50 bg-transparent"
