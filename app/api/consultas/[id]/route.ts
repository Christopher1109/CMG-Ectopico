...
const serviceKey = process.env.SUPABASE_SERVICE_ROLE_KEY!; // <-- SERVICE ROLE (solo server)
...
export async function PATCH(req: Request, { params }: Params) {
  try {
    ...
    const baseFields = [
      "nombre_paciente", "edad_paciente",
      "frecuencia_cardiaca", "presion_sistolica", "presion_diastolica", "estado_conciencia",
      "prueba_embarazo_realizada", "resultado_prueba_embarazo",
      "hallazgos_exploracion", "tiene_eco_transabdominal", "resultado_eco_transabdominal",
      "sintomas_seleccionados", "factores_seleccionados",
    ];
